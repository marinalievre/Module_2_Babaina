...
5.Выводы: 
  ...
  -Так же ключевой столбец score содержит в пределах 10% нулевых значений, которые похожи на выбросы -Выбросы также найдены столбцах Fedu & famrel. Большое количество выбросов в столбце absences. 
